...
const AcTextEditor = class {
  ...
  render() {
    return (index.h(index.Host, { class: {
      ...
      } }, index.h("div", { ref: mediumRef => this.mediumRef = mediumRef, class: "ac-text-editor__editable", onFocus: this.handleFocus, onBlur: this.handleBlur, onChange: this.handleChange }), index.h("input", { name: this.name, value: this.value, type: "hidden" })));
  }
...
exports.ac_text_editor = AcTextEditor;

//# sourceMappingURL=ac-text-editor.cjs.entry.js.map