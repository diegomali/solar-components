...
var vanillaMasker = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
const AcInput = class {
  ...
  render() {
    const icon = this.isShowingPassword ? index_es.faEyeSlash : index_es.faEye;
    return [
      index.h("ac-input-base", { ref: acInputBase => {
          this.acInputBase = acInputBase;
        }, label: this.label, name: this.name, type: this.isShowingPassword ? 'text' : this.type, pattern: this.pattern, value: this.value, disabled: this.disabled, required: this.required, max: this.max, min: this.min, maxlength: this.maxlength, minlength: this.minlength, step: this.step, autofocus: this.autofocus, autocomplete: this.autocomplete, autocapitalize: this.autocapitalize, onChange: this.handleChange, onBlur: this.handleBlur, placeholder: this.placeholder }, index.h("slot", { name: "item-start", slot: "item-start" }), index.h("slot", { name: "input-label", slot: "input-label" }), this.type === 'password'
        ? index.h("ac-button", { slot: "item-end", onClick: this.togglePassword, "icon-only": true, fill: "flat" }, index.h(acFaIcon.AcFaIcon, { icon: icon, size: 14 }))
        : index.h("slot", { name: "item-end", slot: "item-end" })),
      ...
      (this.error && typeof this.error === 'string') || (this.helperText && typeof this.helperText === 'string')
        ? index.h("span", { class: "ac-input__helper-text" }, this.error || this.helperText)
        : null
    ];
  }
...
exports.ac_input = AcInput;

//# sourceMappingURL=ac-input.cjs.entry.js.map