...
const log$1 = browser('solar:FormBehavior');
/**
 * Extend form features.
 */
class FormBehavior extends ComponentBehavior {
  constructor() {
    super(...arguments);
    /**
...
const log = browser('solar:FormFieldBehavior');
/**
 * Adds form field features to a component, such as validations.
 */
class FormFieldBehavior extends ComponentBehavior {
  /**
...
export { FormFieldBehavior as F, toArray as t };

//# sourceMappingURL=form-field-behavior-a15dc06a.js.map