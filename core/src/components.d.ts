...
import { AsyncMetadata } from "./behaviors/async-data-behavior";
...
import { AcDropOption } from "./components/molecules/ac-drop-down-menu/ac-drop-option";
import { ControllerComponentOptions } from "./behaviors/controller-behavior/controller-behavior";
import { AcModal } from "./components/organisms/ac-modal/ac-modal";
import { AcOverlay } from "./components/portals/ac-overlay/ac-overlay";
import { AcNavdrawer } from "./components/atoms/ac-navdrawer/ac-navdrawer";
import { AcPanel } from "./components/organisms/ac-panel/ac-panel";
import { AcPopper } from "./components/portals/ac-popper/ac-popper";
import { Placement, PopperOptions } from "popper.js";
import { Options } from "./components/atoms/ac-table/ac-table";
import { AcToast } from "./components/atoms/ac-toast/ac-toast";
export { AsyncMetadata } from "./behaviors/async-data-behavior";
export { AcOption } from "./utils/types/ac-option";
export { CustomValidityState, ValidatorFn } from "./utils/validations/validations";
export { FormFieldBehavior } from "./behaviors/form-behavior";
export { AcDropOption } from "./components/molecules/ac-drop-down-menu/ac-drop-option";
export { ControllerComponentOptions } from "./behaviors/controller-behavior/controller-behavior";
export { AcModal } from "./components/organisms/ac-modal/ac-modal";
export { AcOverlay } from "./components/portals/ac-overlay/ac-overlay";
export { AcNavdrawer } from "./components/atoms/ac-navdrawer/ac-navdrawer";
export { AcPanel } from "./components/organisms/ac-panel/ac-panel";
export { AcPopper } from "./components/portals/ac-popper/ac-popper";
export { Placement, PopperOptions } from "popper.js";
export { Options } from "./components/atoms/ac-table/ac-table";
export { AcToast } from "./components/atoms/ac-toast/ac-toast";
...
export interface AcAutocompleteCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLAcAutocompleteElement;
}
export interface AcCollapseCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLAcCollapseElement;
}
export interface AcDatePickerCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLAcDatePickerElement;
}
export interface AcDropDownMenuCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLAcDropDownMenuElement;
}
export interface AcLayoutCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLAcLayoutElement;
}
export interface AcMenuCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLAcMenuElement;
}
export interface AcModalCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLAcModalElement;
}
export interface AcNavdrawerCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLAcNavdrawerElement;
}
export interface AcOrderListCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLAcOrderListElement;
}
export interface AcOverlayCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLAcOverlayElement;
}
export interface AcPaginationCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLAcPaginationElement;
}
export interface AcPanelCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLAcPanelElement;
}
export interface AcSelectCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLAcSelectElement;
}
export interface AcStepperCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLAcStepperElement;
}
export interface AcTableCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLAcTableElement;
}
export interface AcTabsCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLAcTabsElement;
}
export interface AcToastCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLAcToastElement;
}
export interface AcUploadCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLAcUploadElement;
}
declare global {
...
declare namespace LocalJSX {
    interface AcAutocomplete {
         ...
         */
        "onSelectChange"?: (event: AcAutocompleteCustomEvent<any>) => void;
        /**
          * The options that will be displayed in the panel.
         */
        "options"?: AcOption[];
    ...
    interface AcCollapse {
        "expanded"?: boolean;
        "onToggle"?: (event: AcCollapseCustomEvent<{ expanded: boolean }>) => void;
    }
    interface AcDatePicker {
        "altField"?: string;
        "altFieldDateFormat"?: string;
        ...
        "name"?: string;
        "offset"?: number;
        "onOnChangeDecade"?: (event: AcDatePickerCustomEvent<any>) => void;
        "onOnChangeMonth"?: (event: AcDatePickerCustomEvent<any>) => void;
        "onOnChangeView"?: (event: AcDatePickerCustomEvent<any>) => void;
        "onOnChangeYear"?: (event: AcDatePickerCustomEvent<any>) => void;
        "onOnHide"?: (event: AcDatePickerCustomEvent<any>) => void;
        "onOnRenderCell"?: (event: AcDatePickerCustomEvent<any>) => void;
        "onOnSelect"?: (event: AcDatePickerCustomEvent<any>) => void;
        "onOnShow"?: (event: AcDatePickerCustomEvent<any>) => void;
        "onlyTimepicker"?: boolean;
        "position"?: string;
        "range"?: boolean;
        /**
    ...
    interface AcDropDownMenu {
         ...
         */
        "onSelectChange"?: (event: AcDropDownMenuCustomEvent<any>) => void;
        /**
          * List of all options.
         */
        "options"?: AcDropOption[];
    ...
    interface AcLayout {
         ...
         */
        "collapsed"?: 'nav-left';
        "onContentScroll"?: (event: AcLayoutCustomEvent<{ top: number, left: number }>) => void;
    }
    /**
     * Accera's Login Page webcomponent.
     */
    ...
    interface AcMenu {
        "iconOnly"?: boolean;
        "noResultsLabel"?: string;
        "onMenuChange"?: (event: AcMenuCustomEvent<string>) => void;
        "searchLabel"?: string;
        "searchable"?: boolean;
        "selected"?: string | number;
    }
    ...
    interface AcModal {
         ...
         */
        "onClose"?: (event: AcModalCustomEvent<void>) => void;
        /**
          * The title that will be displayed on the modal.
         */
        "title"?: string;
    ...
    interface AcNavdrawer {
         ...
         */
        "mode"?: 'push' | 'over';
        "onClose"?: (event: AcNavdrawerCustomEvent<void>) => void;
        /**
          * List of option to be show on the header.
         */
        "options"?: AcDropOption[];
    ...
    interface AcOrderList {
         ...
         */
        "onListChange"?: (event: AcOrderListCustomEvent<AcOrderList>) => void;
        /**
          * List of all options available.
         */
        "options"?: AcOption[];
    ...
    interface AcOverlay {
        ...
        "disableClose"?: boolean;
        "noLayer"?: boolean;
        "onBackDropClick"?: (event: AcOverlayCustomEvent<void>) => void;
        /**
          * Content position based on flex layout.
         */
        "position"?: 'start start' | 'start center' | 'start flex-end' |
    ...
    interface AcPagination {
         ...
         */
        "onPaginationChange"?: (event: AcPaginationCustomEvent<any>) => void;
        /**
          * Used to localize the Previous button label.
         */
        "previousLabel"?: string;
    ...
    interface AcPanel {
        /**
          * Dispatched when the modal closes.
         */
        "onClose"?: (event: AcPanelCustomEvent<void>) => void;
    }
    /**
     * A controller that creates modal on the screen.
     */
    ...
    interface AcSelect {
         ...
         */
        "onSelectChange"?: (event: AcSelectCustomEvent<any>) => void;
        /**
          * The options that will be displayed in the panel.
         */
        "options"?: AcOption[];
    ...
    interface AcStepper {
         ...
         */
        "onStepperChange"?: (event: AcStepperCustomEvent<{ index: number }>) => void;
        /**
          * The count of steps to be displayed. TODO: It mighty support an array of steps in the future.
         */
        "steps"?: number;
    ...
    interface AcTable {
        ...
        "loading"?: boolean;
        "noResultsLabel"?: string;
        "onChangeOrder"?: (event: AcTableCustomEvent<any>) => void;
        "onTableChange"?: (event: AcTableCustomEvent<any>) => void;
        "options"?: Options;
        "params"?: { ordering: string; property: string; selected: number; filters: { limitRows: string; totalRows: string; search: string; }; };
        "selectRow"?: any;
    }
    ...
    interface AcTabs {
        "compact"?: boolean;
        "onTabChange"?: (event: AcTabsCustomEvent<string>) => void;
        "selected"?: string | number;
        /**
          * The theme color defined in the color palette. The default is primary.
         */
    ...
    interface AcToast {
        "message"?: string;
        "onClose"?: (event: AcToastCustomEvent<void>) => void;
        "title"?: string;
        "type"?: 'alert' | 'success' | 'info' | 'warning';
    }
    interface AcToastController {
    ...
    interface AcUpload {
         ...
         */
        "onUploadFile"?: (event: AcUploadCustomEvent<FileList>) => void;
        /**
          * The theme color defined in the color palette. The default is primary.
         */
        "theme"?: string;
